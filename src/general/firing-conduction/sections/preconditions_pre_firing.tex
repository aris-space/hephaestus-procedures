...
\cellcolor{cyan}
  ...
  \cellcolor{cyan}
  \procedureItem{TC, SO, and EIC wear ear protection and safety goggles}{}
  
  \cellcolor{cyan}
  \procedureItem{$\leftrightarrow$ TC to DACS1: announce upcoming \textbf{Valve Functionality Check}}{}
  
  \cellcolor{yellow}
  \procedureItem{$\leftrightarrow$ TC to DACS1: change phase in the UI to \textbf{ValveFC}}{}
  ...
  \cellcolor{yellow}
  \procedureItem{$\leftrightarrow$ TC to DACS: Change phase in the UI to \textbf{LeakageTest}}{}
  ...
  \cellcolor{yellow}
  \procedureItem{$\leftrightarrow$ TC to DACS1: change phase in the UI to \textbf{SparkplugFC}}{}

  \cellcolor{yellow}
  \procedureItem{$\leftrightarrow$ TC to DACS1: turn \textbf{IGNITION KEY} ON}{}
  
  \cellcolor{yellow}
  \procedureItem{$\leftrightarrow$ TC to DACS1: start Sparkplug FC sequence}{}
