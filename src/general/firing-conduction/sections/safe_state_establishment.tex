...
\cellcolor{yellow}
  ...
  \cellcolor{cyan}
  \procedureItem{If recycling, disarm \textbf{OSS PRE-FILL} go back to step 6.71, else continue with 8.43}{}
  ...
  % \cellcolor{yellow}
  % \procedureItem{$\leftrightarrow$ TC to DACS1: open Main Valve (FSS) for 5s}{}

  % \cellcolor{yellow}
  % \procedureItem{$\leftrightarrow$ TC to DACS1: close Purge Valve (OSS)}{}
  ...
  % \cellcolor{yellow}
  % \procedureItem{$\leftrightarrow$ TC to DACS1: close Purge Valve (OSS)}{\iftoggle{firing}{Check igniter lines pressure}{}}
...
\cellcolor{orange}
  \procedureItem{Open Fill Valve (OSS) for 5s}{}
