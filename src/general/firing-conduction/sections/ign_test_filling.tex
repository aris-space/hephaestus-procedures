...
\cellcolor{cyan}
  ...
  \cellcolor{orange}
  \procedureItem{Set Needle Valve (H2 MAIN) to \textcolor{red}{19/8 turns}}{}
  ...
  \cellcolor{orange}
  \procedureItem{Set Needle Valve (O2 IGN) to \textcolor{red}{8/8 turns}}{}
  ...
  \cellcolor{yellow}
  \procedureItem{Change state to \textbf{System Deactivation}}{}
...
\cellcolor{cyan}
\procedureItem{If recycling with LOX still in the system, jump to step \iftoggle{firing}{6.132}{6.54}, else continue with step \iftoggle{firing}{6.105}{6.28}}{}
...
\cellcolor{orange}
  \procedureItem{Open Drain Valve (OSS FILL) about half way}{}
...
\cellcolor{cyan}
  \procedureItem{Jump to step 6.152, oxidizer filling}{}
...
\cellcolor{cyan}
\procedureItem{Proceed with step 6.152, oxidizer filling}{}
...
\cellcolor{orange}
  \procedureItem{Slowly open LOX Dewar Valve (set it to a certain value and do not adjust any further $\rightarrow$ better data) \\ If Dewar Pressure drops below 3 barg:
  $\rightarrow$ Repressurize LOX Dewar}{}

\cellcolor{cyan}
  \procedureItem{Wait until OSS Mainline Temperature reaches -160}{}
