...
\procedureItem{Inform \textbf{\#hephaestus-testing} about the test using the slack workflow}{}
  ...
  \cellcolor{cyan} 
  \iftoggle{firing}{\procedureItem{Check that access request to airfield for all attendees has been sent out to MP (check on excel list)}{PERSEUS Sharepoint -> Testing}}{}
