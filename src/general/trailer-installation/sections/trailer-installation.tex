...
\begin{tabularx}{\textwidth}{|>{\columncolor{tableColumnColor}}c|>{\columncolor{tableColumnColor}}c|>{\hsize=1.2\hsize}X|>{\hsize=.8\hsize}X|}
  ...
  \procedureItem{Position the trailer such that the front legs are on the edge of the concrete ground. Also check the distance to the Hunter Stübli because of the cable length. Use safety map as orientation. \includegraphics[width=\linewidth]{assets/position_map.png} }{}
  ...
  \procedureItem{Put wheel chock behind each wheel}{Make sure it's fully at the wheel}
