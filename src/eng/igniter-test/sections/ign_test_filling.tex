...
\cellcolor{cyan}
  ...
  \cellcolor{orange}
  \procedureItem{Set Needle Valve (H2 MAIN) to desired amount of turns}{\textcolor{red}{PRO: 7/8 turns}}
  ...
  \cellcolor{orange}
  \procedureItem{Set Needle Valve (O2 IGN) to desired amount of turns}{\textcolor{red}{PRO: 3/8 turns}}
...
%  \procedureItem{$\leftrightarrow$ TC to DACS1: check FSS Load Cell readings}{}
 ...
 % \cellcolor{orange}
 % \procedureItem{Mount drain line (FSS) to the FSS Drain Valve}{}
...
%  \cellcolor{cyan}
%  \procedureItem{EIC wears ear protection, safety goggles, cryo-gloves, cryo-face-shield and cryo-apron}{}
...
%\cellcolor{orange}
%  \procedureItem{Check that OSS Main Valve is CLOSED}{}
...
%\cellcolor{cyan}
%  \procedureItem{Ensure that no one is in front of the OSS Vent Valve}{}

%\cellcolor{yellow}
%  \procedureItem{$\leftrightarrow$TC to DACS1: open OSS Vent Valve for 2s}{}
...
%\cellcolor{yellow}
%  \procedureItem{$\leftrightarrow$TC to DACS1: open OSS Fill Valve for 5s (N2 will leave the system) \\ Check whether or not N2 is actually flowing through both flexible line and Drain Valve (OSS FILL)}{}
...
%\cellcolor{yellow}
%  \procedureItem{$\leftrightarrow$TC to DACS1: open OSS Fill Valve for 5s (N2 will leave the system)}{}
...
%\cellcolor{yellow}
%  \procedureItem{$\leftrightarrow$TC to DACS1: open OSS Fill Valve}{}
...
%      \item If OSS Fill Valve closes unexpectedly:
%      \begin{itemize}
%          \item Immediately close LOX Dewar Valve
...
%\cellcolor{yellow}
%  \procedureItem{$\leftrightarrow$TC to DACS1: close OSS Fill Valve}{}
...
%\cellcolor{green}
%  \procedureItem{Check that OSS Vent Valve is fully closed (yellow-blue indicator)}{}
