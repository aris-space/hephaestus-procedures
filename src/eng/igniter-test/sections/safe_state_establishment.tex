...
%  \procedureItem{Set Pressure Reducer (FSS PRZ) to 5 bar}{}
 ...
 % \cellcolor{yellow}
 % \procedureItem{$\leftrightarrow$ TC to DACS1: open FSS Main Valve for 5s}{\hl{CROSS CONTAMINATION????}}
 ...
 % \procedureItem{Wait until FSS Pressure above Tank is equal to 0.0 barg}{}
  ...
  % \cellcolor{yellow}
  % \procedureItem{$\leftrightarrow$ TC to DACS1: close FSS Purge Valve}{}
  
  % \cellcolor{yellow}
  % \procedureItem{$\leftrightarrow$ TC to DACS1: close OSS Purge Valve}{Check igniter lines pressure}
...
%\cellcolor{yellow}
% \procedureItem{$\leftrightarrow$ TC to DACS1: open OSS Fill Valve for 5s}{}
