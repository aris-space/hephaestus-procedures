...
\cellcolor{cyan}
  ...
  \cellcolor{cyan}
  \procedureItem{$\rightarrow$ From now on only TC, SO, and EIC/ENG1 approach the trailer, except if explicitly demanded by an operation procedure or with the explicit consent of the TC or SO}{}
  
  \cellcolor{cyan}
  \procedureItem{Tasks:
    \begin{itemize}
      \item TC, SO, and EIC go to trailer → carry ear protection with you. Take face shields to the trailer
...
\cellcolor{cyan}
  ...
  \cellcolor{cyan}
  \procedureItem{TC, SO, and EIC approach the trailer}{}
