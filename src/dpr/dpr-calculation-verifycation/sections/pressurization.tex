...
Check line between bottle and Pressure Reducer (FSS PRZ) for leaks (i.e. apply snoop to all fittings)}{}
  ...
  \begin{itemize}
    \item If you want to do another test with same valve opening time: jump to point 3.28 
    \item If you want to do another test with a different valve opening time jump to point 3.31
    \item If you want to end the test jump to point 3.33
  \end{itemize}
  }{}
  ...
  \procedureItem{Go back to point 3.28}{}
