...
Check line between bottle and Pressure Reducer (FSS PRZ) for leaks (i.e. apply snoop to all fittings)}{}
  ...
  \procedureItem{Change phase in the UI (if we want to have a special phase for the test)}{}
  ...
  \procedureItem{$\leftrightarrow$TC to DACS1: Close Pressurization Valve (FSS)}{}
  ...
  \begin{itemize}
    \item If you want to do another test with same valve opening time: jump to point 4.36 
    \item If you want to do another test with a different valve opening time jump to point 4.35
    \item If you want to end the test jump to point 4.36
  \end{itemize}
  }{}
  ...
  \procedureItem{In case you want to do another test with an updated opening time start again with point 4.2}{}
