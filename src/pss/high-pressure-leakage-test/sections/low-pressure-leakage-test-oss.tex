...
\begin{tabularx}{\textwidth}{|>{\columncolor{tableColumnColor}}c|>{\columncolor{tableColumnColor}}c|>{\hsize=1.2\hsize}X|>{\hsize=.8\hsize}X|}
  ...
  \procedureItem{$\leftrightarrow$TC to DACS1: Open Main Valve (OSS MAIN)}{}
...
\begin{itemize}
  ...
  \item Ensure that no one is in front of Vent Valve (OSS)
  \item Open Vent Valve (OSS)
  ...
  \item Close Vent Valve (OSS)
  \item Retighten all marked fittings and go back to step 1.5.
  \item If there are no leaks: go back to step 1.5. and repeat with 10 bar
  \item If there are still no leaks: continue with step 1.10.
\end{itemize}
}{}
  
  \procedureItem{Close N2 Bottle Valve (OSS PRZ) fully}{}
  
  \procedureItem{Ensure that no one is in front of Vent Valve (OSS)}{}
  ...
  \procedureItem{$\leftrightarrow$TC to DACS1: close Main Valve (OSS MAIN)}{}
